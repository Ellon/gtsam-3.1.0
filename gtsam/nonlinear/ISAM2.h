...
struct GTSAM_EXPORT ISAM2Params {
  ...
  bool isFindUnusedFactorSlots() const { return findUnusedFactorSlots; }
  ...
  void setFindUnusedFactorSlots(bool findUnusedFactorSlots) { this->findUnusedFactorSlots = findUnusedFactorSlots; }
